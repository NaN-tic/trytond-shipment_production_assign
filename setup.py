...
setup(name='%s_%s' % (PREFIX, MODULE),
    ...
    url='https://github.com/NaN-tic/trytond-shipment_production_assign',
    download_url='https://github.com:nantic/trytond-shipment_production_assign.git',
    ...
    project_urls = {
       "Source Code": 'https://github.com:NaN-tic/trytond-shipment_production_assign.git'
    },
    classifiers=[
